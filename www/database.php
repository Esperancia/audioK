...
Project Page: http://github.com/sunnysingh/database
    ...
    $db->connection										A hook to the actual MySQLi class. It is used internally and should only be used when a feature is not part of the framework but is part of the MySQLi class.
	...
	$db->server_info, $db->client_info, $db->host_info	Exactly the same as the MySQLi counterparts.
	$db->insert_id										Contains the auto_increment generated ID from the last INSERT query
	...
	$db->query_count_success							Contains the total number of successful queries
	$db->query_count_error								Contains the total number of failed queries
